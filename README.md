# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Retail Procurement Orders
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-orders
```
...
```php
<?php
use Amz\VendorOrders\ResponseTypes;
